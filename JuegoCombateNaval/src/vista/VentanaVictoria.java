...
public class VentanaVictoria extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(textoIDU, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 56, 100, -1));
        jPanel1.add(textoNombreU, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 96, 100, -1));
        jPanel1.add(textoAliasU, new org.netbeans.lib.awtextra.AbsoluteConstraints(156, 136, 100, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 18)); // NOI18N
        jLabel1.setText("Su ID");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 60, -1));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 50, -1));

        botonGrabar.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        jPanel1.add(botonGrabar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, -1, -1));

        jLabel4.setFont(new java.awt.Font("Tahoma", 3, 36)); // NOI18N
        jLabel4.setText("VICTORIA!");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 40, 210, -1));

        botonSaltar.setFont(new java.awt.Font("Tahoma", 3, 14)); // NOI18N
        ...
        jPanel1.add(botonSaltar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, -1, -1));

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/spr.Victoria.jpg"))); // NOI18N
        jLabel5.setText("jLabel5");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(-430, -40, 1530, 740));
    ...
    private void botonGrabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonGrabarActionPerformed
        ...
        if (new RegistroJugadores().validarId(id) == false) {
            ...
            jug.setCantidadVictorias(1);
            jug.setCantidadDerrotas(0);
